...
class StatementConvert:
    ...
    def convertInfoForSm120(cur_line_no, csv_values, cbSetValueList):
        ...
        if csv_values.get("Commodity"):
            ...
            max_line = 4
            try:
                max_length = int(csv_values.get("CommodityMaxLength"))
            except:
                pass
            try:
                font = int(csv_values.get("CommodityFont"))
            except:
                pass
            try:
                max_line = int(csv_values.get("CommodityMaxLine"))
            except:
                pass
        ...
        if csv_values.get("SpecialMessage"):
            ...
            max_line = 10
            try:
                max_length = int(csv_values.get("SpecialMessageMaxLength"))
            except:
                pass
            try:
                font = int(csv_values.get("SpecialMessageFont"))
            except:
                pass
            try:
                max_line = int(csv_values.get("SpecialMessageMaxLine"))
            except:
                pass
            ...
            for index, value in enumerate(data_lines[:max_line]):
                cbSetValueList(tableNameSPM, "Code", line_no=index + 1,
                               value=csv_values.get("SpmCode") or str(cur_line_no))
            ...
            for index in xrange(10):
                if csv_values.get("SpecialMessage%d" % (index + 1)):
                    cbSetValueList(tableNameSPM, "Code", line_no=index + 1,
                                   value=csv_values.get("SpmCode") or str(cur_line_no))
                    cbSetValueList(tableNameSPM, "LineNo", line_no=index + 1, value=str(index + 1))
                    cbSetValueList(tableNameSPM, "Flag", line_no=index + 1,
                                   value=csv_values.get("SpecialMessage%dFont" % (index + 1)) or "0")
                    cbSetValueList(tableNameSPM, "Data", line_no=index + 1,
                                   value=csv_values.get("SpecialMessage%d" % (index + 1)).replace('"', '""'))
        ...
        if csv_values.get("Ingredient"):
            ...
            max_line = 10
            try:
                max_length = int(csv_values.get("IngredientMaxLength"))
            except:
                pass
            try:
                font = int(csv_values.get("IngredientFont"))
            except:
                pass
            try:
                max_line = int(csv_values.get("IngredientMaxLine"))
            except:
                pass
            ...
            for index, value in enumerate(data_lines[:max_line]):
                cbSetValueList(tableNameING, "Code", line_no=index + 1,
                               value=csv_values.get("IngCode") or str(cur_line_no))
            ...
            for index in xrange(10):
                if csv_values.get("Ingredient%d" % (index + 1)):
                    cbSetValueList(tableNameING, "Code", line_no=index + 1,
                                   value=csv_values.get("IngCode") or str(cur_line_no))
                    cbSetValueList(tableNameING, "LineNo", line_no=index + 1, value=str(index + 1))
                    cbSetValueList(tableNameING, "Flag", line_no=index + 1,
                                   value=csv_values.get("Ingredient%dFont" % (index + 1)) or "0")
        ...
        if csv_values.get("Multibarcode2"):
            ...
            cbSetValueList(tableNameMUB, "MultiBarcodeType", line_no=2,
                           value="2" if csv_values.get("NoLinkTo2DBarcodeText") else "3")
            ...
            if csv_values.get("NoLinkTo2DBarcodeText"):
                ...
                cbSetValueList(tableNameMUB, "Link2DBarcodeTextNo", line_no=2,
                               value=csv_values.get("TbtCode") or str(cur_line_no))
                try:
                    ...
                    for mul2_index, mul2_data in enumerate(mul2_data_list[:10]):
                        cbSetValueList(tableNameTBT, "Code", line_no=mul2_index + 1,
                                       value=csv_values.get("TbtCode") or str(cur_line_no))
    ...
    def convertInfoForSm110(cur_line_no, csv_values, cbSetValueList):
        ...
        if tmp_placecode:
            ...
            if tmp_placename:
                ...
                cbSetValueList(tableNamePLA, "PlaceName",
                               '%s,"%s"' % (csv_values.get("PlaceFont") or '21', tmp_placename.replace('"', '""')))
        ...
        if csv_values.get("Text1"):
            ...
            cbSetValueList(tableNameTEX, "Name", line_no=1, value='%s,"%s"' % (
            csv_values.get("Text1Font") or '21', csv_values.get("Text1").replace('"', '""')))
        ...
        if csv_values.get("Text2"):
            ...
            cbSetValueList(tableNameTEX, "Name", line_no=2, value='%s,"%s"' % (
            csv_values.get("Text2Font") or '21', csv_values.get("Text2").replace('"', '""')))
        ...
        if csv_values.get("Text3"):
            ...
            cbSetValueList(tableNameTEX, "Name", line_no=3, value='%s,"%s"' % (
            csv_values.get("Text3Font") or '21', csv_values.get("Text3").replace('"', '""')))
        ...
        if csv_values.get("Text4"):
            ...
            cbSetValueList(tableNameTEX, "Name", line_no=4, value='%s,"%s"' % (
            csv_values.get("Text4Font") or '21', csv_values.get("Text4").replace('"', '""')))
        ...
        if csv_values.get("Text5"):
            ...
            cbSetValueList(tableNameTEX, "Name", line_no=5, value='%s,"%s"' % (
            csv_values.get("Text5Font") or '21', csv_values.get("Text5").replace('"', '""')))
        ...
        if csv_values.get("Commodity"):
            ...
            max_comm_line = 4
            try:
                max_comm_length = int(csv_values.get("CommodityMaxLength"))
            except:
                pass
            try:
                comm_font = int(csv_values.get("CommodityFont"))
            except:
                pass
            try:
                max_comm_line = int(csv_values.get("CommodityMaxLine"))
            except:
                pass
            ...
            cbSetValueList(tableNamePLU, "Commodity",
                           "\n".join(['%d,"%s"' % (comm_font, comm_data_line.replace('"', '""')) for comm_data_line in
                                      comm_data_lines[:max_comm_line]])
                           )
        else:
            # 上层软件已分行
            j = -1
            ...
            for i in xrange(j):
                ...
                cur_font = 20
                try:
                    cur_font = int(csv_values.get(commNameFont))
                except:
                    pass
        ...
        if csv_values.get("SpecialMessage"):
            ...
            max_spm_line = 10
            try:
                max_spm_length = int(csv_values.get("SpecialMessageMaxLength"))
            except:
                pass
            try:
                spm_font = int(csv_values.get("SpecialMessageFont"))
            except:
                pass
            try:
                max_spm_line = int(csv_values.get("SpecialMessageMaxLine"))
            except:
                pass
            ...
            cbSetValueList(tableNamePLU, "SpecialMessage",
                           "\n".join(['%d,"%s"' % (spm_font, spm_data_line.replace('"', '""')) for spm_data_line in
                                      spm_data_lines[:max_spm_line]])
                           )
        else:
            # 上层软件已分行
            j = -1
            ...
            for i in xrange(j):
                ...
                cur_font = 20
                try:
                    cur_font = int(csv_values.get(spmNameFont))
                except:
                    pass
        ...
        if csv_values.get("Ingredient"):
            ...
            max_ing_line = 10
            try:
                max_ing_length = int(csv_values.get("IngredientMaxLength"))
            except:
                pass
            try:
                ing_font = int(csv_values.get("IngredientFont"))
            except:
                pass
            try:
                max_ing_line = int(csv_values.get("IngredientMaxLine"))
            except:
                pass
            ...
            cbSetValueList(tableNamePLU, "Ingredient",
                           "\n".join(['%d,"%s"' % (ing_font, ing_data_line.replace('"', '""')) for ing_data_line in
                                      ing_data_lines[:max_ing_line]])
                           )
        else:
            # 上层软件已分行
            j = -1
            ...
            for i in xrange(j):
                ...
                cur_font = 20
                try:
                    cur_font = int(csv_values.get(ingNameFont))
                except:
                    pass
